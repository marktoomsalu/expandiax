-- ============================================================
-- Attach a Spotify artist to a concert/festival so their photo can
-- stand in as the event's cover when no photo has been uploaded yet —
-- on event cards, the event page hero, and the feed.
-- ============================================================

alter table public.events
  add column spotify_artist_id text,
  add column spotify_artist_name text,
  add column spotify_artist_image text;
