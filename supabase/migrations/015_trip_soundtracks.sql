-- ============================================================
-- Trip soundtracks: attach a Spotify track to a country visit ("the
-- soundtrack of that trip"), shown on the country page and playable in
-- the feed via Spotify's official embed widget (no unofficial audio
-- streaming — just their iframe player, so this stays within Spotify's
-- terms). Track metadata is cached at pick time so pages can render it
-- without a live Spotify call.
-- ============================================================
